...
SLEEPMATE_SAMPLING_TEMPERATURE = float(
    os.environ.get("SLEEPMATE_SAMPLING_TEMPERATURE", 0.1)
)
...
remind them about those either. The human might be feeling tired so be
sensitive, don't assume they're feeling chipper."""
